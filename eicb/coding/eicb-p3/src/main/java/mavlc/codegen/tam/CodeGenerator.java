...
public class CodeGenerator extends AstNodeBaseVisitor<Instruction, Void> {
	...
	public Instruction visitLeftHandIdentifier(LeftHandIdentifier leftHandIdentifier, Void __) {
        ...
        assembler.loadAddress(Register.LB, declaration.getLocalBaseOffset()).addName(leftHandIdentifier.name).addComment("laod address of " + leftHandIdentifier.name);
        return null;
	}
	...
	public Instruction visitRecordLhsIdentifier(RecordLhsIdentifier recordLhsIdentifier, Void __) {
        ...
        for (RecordElementDeclaration element : type.typeDeclaration.elements) {
            if(element.name.equals(recordLhsIdentifier.name)){
                break;
            } else {
        ...
        assembler.loadAddress(Register.LB, base + fieldOffset).addName(name).addComment("laod address of " + name) ;
		return null;
	}
