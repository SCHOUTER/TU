...
% % Comment: Hier wäre die Grafik von Seite 4 ("Semantic Gap") nützlich, um die Diskrepanz zwischen Hochsprache und Hardware zu visualisieren.
...
Der Datenspeicher ist in Stack und Heap unterteilt. In der TAM wachsen diese Bereiche aufeinander zu (siehe Speicherverwaltung).
...
\begin{itemize}
  ...
  \item \defc{LB} (Local Base): Zeiger auf den aktuellen \textit{Stack Frame} (Beginn der lokalen Variablen der aktuellen Prozedur).
\end{itemize}

% % Comment: Hier wäre die Grafik von Seite 10 (TAM Speicherbereiche) sehr hilfreich, um die Anordnung von Stack, Heap und Code zu verstehen.
...
% % Comment: Die Grafik von Seite 29 (Dynamische Arrays im Speicher) visualisiert gut den Unterschied zwischen dem Deskriptor auf dem Stack und den Daten im Heap.
...
% % Comment: Grafik Seite 47 (Aufbau Stack Frame) ist essenziell.
...
% % Comment: Die Grafiken auf Seite 69 (Vor/Nach Call/Return) zeigen sehr gut, wie der Stack atmet.
