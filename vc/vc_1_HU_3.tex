...
\author{Niclas Kusenbach, 360227 \and Alicia Bayerl, 2633336 \and Mohamed Naceur Hedhili \and Selma Naz Öner}
...
\section*{Aufgabe 3.1}
\subsection*{a) Skizze einer Lochkamera}
...
P(C_k \mid x),
\]
also die Wahrscheinlichkeit, dass verbotene Gegenstände im Gepäck sind, wenn ein Alarm ausgelöst wurde.
...
\subsection*{a) Klassifikationsentscheidung}
...
Gegeben sind die A-priori-Wahrscheinlichkeiten:
\begin{itemize}
    \item $P(a) = 0{,}33$
    \item $P(b) = 0{,}67$
\end{itemize}
...
\subsection*{a) Repräsentation des Objekts}
...
\subsection*{c) Klassifikator und Lernmethode}
