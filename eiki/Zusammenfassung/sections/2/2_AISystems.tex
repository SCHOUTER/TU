...
% [Bild: Darstellung der Interaktion zwischen Agent und Umgebung: Sensoren nehmen Wahrnehmungen (Percepts) auf, Agent entscheidet, Aktuatoren führen Aktionen aus.]
...
\end{itemize}
% [Bild: Diagramm eines Simple Reflex Agent: Percept -> Sensoren -> Was ist die Welt jetzt -> Bedingung-Aktion-Regeln -> Aktion -> Aktuatoren]
...
\end{itemize}
% [Bild: Diagramm Model-based Agent: Hinzugefügt ist 'State' und 'How the world evolves']
...
\end{itemize}
% [Bild: Diagramm Goal-based Agent: 'What is the world like now' -> 'What it will be like if I do action A' -> 'Goals' -> Aktion]
...
\begin{itemize}
    ...
    \item \textbf{Vorteil:} Ermöglicht rationale Entscheidungen bei
          ...
          \end{itemize}
\end{itemize}
% [Bild: Diagramm Utility-based Agent: Statt 'Goals' gibt es eine 'Utility'-Box, die den Nutzen maximiert]
...
\begin{defbox}[Komponenten eines lernenden Agenten]
    ...
    \end{itemize}
\end{defbox}
% [Bild: Diagramm Learning Agent, das die Interaktion der vier Komponenten zeigt]
