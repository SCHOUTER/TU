...
\begin{itemize}
  \item \textbf{Frontier (Open List):} Menge der generierten, aber noch nicht expandierten Knoten.
  \item \textbf{Expansion:} Anwenden der Aktionen auf einen Zustand, um Kindknoten zu generieren.
\end{itemize}

% [Hier Grafik einfügen: Darstellung eines Suchbaums mit Frontier und expandierten Knoten]
...
Expandiert den flachsten Knoten in der Frontier zuerst (FIFO-Queue).
\begin{itemize}
...
Expandiert den tiefsten Knoten in der Frontier zuerst (LIFO-Queue / Stack).
\begin{itemize}
...
% [Hier Grafik einfügen: Vergleich von Suchradien bei verschiedenen Heuristiken]
