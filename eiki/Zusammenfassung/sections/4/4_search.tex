...
% Grafik: Landschaft der Zielfunktion mit lokalem Maximum, globalem Maximum, Schulter und flachem Maximum.
% [Hier sollte eine Grafik der 'Objective Function Landscape' eingefügt werden]
...
% Grafik: Ein Spielbaum für Tic-Tac-Toe oder ein abstrakter Baum mit MAX/MIN Ebenen und propagierten Werten.
% [Hier sollte eine Grafik eines Minimax-Baums eingefügt werden]
